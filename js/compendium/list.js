...
function compendium_admin_list_search( sort_data = null )
{
  ...
  postdata += '&compendium_search_summary='     + fetch_sanitize_id('compendium_search_summary');
...
function compendium_missing_list_search( sort_data = null )
{
  ...
  postdata += '&compendium_missing_links='      + fetch_sanitize_id('compendium_missing_links');
