...
___('politics_manifesto_subtitle',        'EN', "THE CONTRAPOSITIONIST MANIFESTO");
___('politics_manifesto_subtitle',        'FR', "LE MANIFESTE CONTRAPOSITIONNISTE");
...
Créant un besoin artificiel d'argent afin de transformer les classes inférieures en esclaves de leurs salaires, le haut de la chaîne alimentaire capitaliste ne contribue quasiment rien à la société et abuse de sa fortune injustement obtenue afin de s'assurer que les autres restent à leur place. Maintenir ce statu quo d'oppression et d'oppressés est l'objectif principal du capitalisme, protégé par l'illusion que n'importe qui peut devenir riche et s'asseoir à son tour au sommet de la pyramide. L'idée même de s'entraider dans le but d'une ascension sociale collective est perçu comme dangereux dans ce système égoïste.
EOT
);
...
Notre société se dirige délibérément vers son effondrement total. Les conséquences écologiques d'une surconsommation insoutenable menacent l'existence future de l'espèce humaine. Cette vision volontairement court-termiste est un effet secondaire de la cupidité infinie du capitalisme, les riches se remplissant les poches sans se soucier des conséquences, forçant les classes inférieures à piller les ressources de la planète à leur service. Dans une telle situation, il ne faut pas perdre de temps pour agir : l'équilibre écologique de la Terre, déjà précaire aujourd'hui, se dirige vers un effondrement irréversible.
EOT
);
...
Contraposition est un mot d'inspiration latine qui signifie « s'opposer à ». Ce manifeste est contrapositionniste : il s'oppose à tout ce que le système sociopolitique actuel représente. Tout ce que nous accomplissons en tant que société capitaliste est fait pour être jeté après usage, sans prêter la moindre attention au futur sauf s'il s'agit d'un investissement financier, sans prêter la moindre attention aux victimes du système sauf s'il est financièrement intéressant de les ménager. Nous vénérons la croissance économique comme s'il s'agissait d'une divinité, érigeant des autels en son nom à partir des ossements de ses victimes.
EOT
);
...
Cette situation doit prendre fin au plus vite, et un nouveau système doit naître des cendres de l'actuel. Dans ce manifeste, nous exposerons en quoi le système actuel est un échec indéniable, puis proposerons des façons concrètes de construire la nouvelle société qui doit remplacer l'actuelle.
EOT
);
...
Certaines tournures de langage peuvent être excluantes. C'est pourquoi le manifeste contrapositionniste utilise le langage le plus simple possible. Des phrases articulées, du vocabulaire clair. Tout le monde devrait pouvoir comprendre la théorie politique, qui est habituellement complexe et réservée aux élites.
EOT
);
...
Le français est une langue fortement genrée. L'utilisation par défaut du masculin est un des nombreux moyens subtils de rappeler aux femmes et aux non-binaires que leur place dans la société est au second plan. Pourtant, le français peut être utilisé de façon neutre, sans masculin ni féminin. Ce manifeste prêche l'inclusivité, le langage utilisé y sera donc non-binaire et non-genré.
EOT
);
...
Vous vous demandez probablement pourquoi un mot aussi long et inconfortable que « contrapositionniste » a été choisi. Comme pour tous les nouveaux concepts et mouvements, les noms semblent étranges jusqu'à ce qu'ils deviennent assez populaires pour devenir normaux. Le contrapositionnisme, ou en plus court contra, représente l'essence distillée de ce manifeste : la neutralité et les compromis profitent à la classe dirigeante. L'opposition totale à l'intégralité de leurs idéaux est la seule voie menant à un réel changement.
EOT
);
...
La conception de la théorie contrapositionniste repose sur d'autres théories politiques. Le marxisme, le socialisme, le communisme, l'anarchisme, le féminisme, la justice sociale, le pacifisme, ont été d'importantes sources d'inspiration. Ce manifeste contient une justification de la décision de vouloir créer un nouveau paradigme plutôt que de se contenter des existants, en expliquant pourquoi le contrapositionnisme s'oppose à certaines composantes de ces autres idéologies.
EOT
);
___('politics_manifesto_intro_6',       'EN', <<<EOT
...
___('politics_manifesto_intro_6',       'FR', <<<EOT
Nous allons commencer par explorer les aspects violents du système, en dénonçant l'oppression, la domination, la soumission, et l'esclavage salarial que la majorité des gens subissent. Nous canaliserons ensuite cette colère pour réfléchir calmement aux moyens de grandir ensemble, de se tirer collectivement vers le haut, et de devenir de meilleurs individus et une meilleure société sans pour autant avoir recours à la violence qui peut nous être instinctivement inspirée par cette colère.
EOT
);
___('politics_manifesto_intro_7',       'EN', <<<EOT
This manifesto has been kept as short as possible. A sum of its whole, no section is meant to be skipped.
EOT
);
___('politics_manifesto_intro_7',       'FR', <<<EOT
...
Pourtant, l'effondrement de ce système est le rêve de toute personne qui accepte de le voir tel qu'il est réellement. Ce qui vous est présenté comme un « contrat social » est en réalité un lien de domination entre les classes dominantes et le reste de la société. Les personnes qui naissent dans une situation de privilège profitent d'un « contrat social » plus avantageux que celui des autres. La loi ne s'applique pas à ces gens avec le même degré de rigueur, la justice n'utilise pas le même degré de violence envers eux. Même lorsqu'il s'agit de travailler ou de produire de la valeur pour le bien commun de la société le « contrat social » n'est qu'une simple option pour eux : ils en ont tous les bénéfices mais n'ont pas à en respecter les conditions.
EOT
);
...
Aucune société ne peut affirmer qu'elle offre de la liberté ou de la représentation politique lorsque sa force salariale passe la majorité de ses journées à travailler pour les intérêts d'autocraties privées. Cette société vous offre prétendument le droit d'être vous-même, mais lorsque l'on vous demande quelle est votre valeur, vous ne répondrez pas « Je m'intéresse à la sociologie », « Je maîtrise en charpenterie », « J'aide les gens dans le besoin », ou même « Je suis un être humain », mais donnerez plutôt un nombre : votre valeur financière. C'est à cela que le système capitaliste vous réduit. Un simple nombre.
EOT
);
...
The ultra rich's accumulation of wealth knows no limit, growing boundlessly only to be transferred to the next generation through the patrilineal inheritance system that we have maintained since the feudal era. They would be angry if they discovered a resource leak within their corporations, yet their obscene accumulation of wealth is a resource leak in a system where those resources could be used for the common good. Their endless race for growth forces society as a whole to exhaust the planet's resources, which are necessary for citizens of poorer countries to simply survive and have a future at all.
EOT
);
...
Rien ne peut justifier l'existence des ultra-riches dans une société où la pauvreté existe également. Toutefois, les classes dominantes utilisent leur position de pouvoir pour répandre le mépris de classe, nous faisant craindre les personnes défavorisées au lieu de nous sensibiliser à leur souffrance. Les frontières fermées permettent de s'assurer que les personnes qui naissent dans des régions pauvres du monde ne bénéficieront jamais des opportunités que les pays riches pourraient leur offrir. En divisant le peuple par la haine et en maintenant le racisme systémique via leur influence politique, les classes sociales supérieures se maintiennent au sommêt, s'assurant que des aspects de notre personne que nous ne pourrons jamais changer - nos ancêtres, notre couleur de peau, notre identité de genre, notre orientation sexuelle, nos handicaps physiques - contribueront en continu à pousser les minorités vers le bas de la hiérarchie sociale.
EOT
);
...
Tous ces pays ne sont pourtant que des territoires arbitraires dont les frontières ont été définies par les ancêtres de nos ancêtres, souvent même volés aux indigènes qui y vivaient initialement. Ils n'ont de valeur qu'aux yeux des gens qui ont été intégralement endoctrinés par le système éducatif, dont la conception de l'Histoire inclut beaucoup de révisionnisme historique. C'est une honte, car l'éducation est de loin l'outil le plus important dans la quête de la réduction des inégalités et du progrès social. Plutôt que de l'utiliser de façon constructive, la classe dominante politique utilise l'éducation comme un outil de propagande, reprenant des techniques optimisées il y a longtemps par les fascistes et les nazis.
EOT
);
...
Pour maintenir leur emprise sur le peuple, la classe politique et les riches utilisent les services des forces de police. Théoriquement censées protéger tous les citoyens, elles s'assureront plutôt que la loi ne s'applique qu'aux défavorisés, par l'usage de la violence. Tout membre des forces de l'ordre tentant de protester de l'intérieur contre ce rôle de chien de garde se fera taire, faisant de la police d'état un gang de criminels. Les forces de police étant rarement punies lorsqu'elles abusent de leurs pouvoirs, elles développent l'impression qu'elles sont au dessus de la loi, ce qui crée une escalade constante de l'usage unilatéral de la violence. Ce n'est pas par provocation que beaucoup de personnes défavorisées, une fois confrontées à ce système policier injuste, ont tendance à dire que tous les policiers sont des salauds. Le travail de policier, même s'il est souvent présenté comme allié du peuple, est en pratique la main armée des mécaniques de domination.
EOT
);
...
La neutralité politique encourage le capitalisme, le fascisme, le totalitarisme. Nous ne pouvons pas la tolérer.
EOT
);
...
___('politics_manifesto_work_quote',  'FR', "La croissance non maîtrisée et sans limite ressemble au fonctionnement d'un cancer");
...
___('politics_manifesto_inspirations_title',  'EN', "Inspirations and rejections");
___('politics_manifesto_inspirations_title',  'FR', "Inspirations et oppositions");
___('politics_manifesto_inspirations_quote',  'EN', "Another way is possible for those who struggle to find an ideology that they fully agree with");
___('politics_manifesto_inspirations_quote',  'FR', "D'autres voies peuvent s'ouvrir à vous si vous ne parvenez pas à trouver une idéologie qui vous convient parfaitement");
___('politics_manifesto_inspirations_1',      'EN', <<<EOT
...
___('politics_manifesto_inspirations_1',      'FR', <<<EOT
...
___('politics_manifesto_inspirations_2',      'EN', <<<EOT
...
___('politics_manifesto_inspirations_2',      'FR', <<<EOT
...
___('politics_manifesto_inspirations_3',      'EN', <<<EOT
...
___('politics_manifesto_inspirations_4',      'FR', <<<EOT
...
___('politics_manifesto_inspirations_5',      'EN', <<<EOT
...
___('politics_manifesto_inspirations_5',      'FR', <<<EOT
...
___('politics_manifesto_inspirations_6',      'EN', <<<EOT
...
___('politics_manifesto_inspirations_8',      'FR', <<<EOT
...
___('politics_manifesto_inspirations_9',      'EN', <<<EOT
...
___('politics_manifesto_inspirations_12',     'FR', <<<EOT
...
___('politics_manifesto_inspirations_13',     'EN', <<<EOT
Until the system gets overthrown, we are stronger together.
EOT
);
___('politics_manifesto_inspirations_13',     'FR', <<<EOT
...
Mettre la colère et le rejet au cœur de sa vision du monde est malsain. La colère envers le système, bien qu'un exutoire important pour évacuer sa douleur et sa souffrance, est une source d'anxiété et de tristesse au quotidien. Il est crucial d'apprendre à canaliser l'énergie négative que cause l'écrasement constant par les rouages du système et de la transformer en motivation pour accomplir des choses positives - une tâche complexe que tout le monde n'est pas capable d'accomplir.
EOT
);
...
Siddhārtha Gautama, après avoir renoncé à sa vie de luxe pour devenir ascèse, a réalisé que la paix vient de l'intérieur de soi. Peu importe ce qui vous entoure, peu importe la quantité de violence systémique dont vous souffrez, il est important de toujours trouver la force de travailler sur soi-même afin d'avoir une quantité minimale de paix intérieure. Les classes privilégiées gagnent à vous pousser à l'énervement perpétuel, car l'énervement obscurcit le jugement et divise les opposants du système.
EOT
);
...
Dans un effort de libération mentale de l'oppression de la société, il est nécessaire de vous défaire et de défaire les autres de leur toxicité. Rejetez autant que possible les personnes chaotiques. Éloignez-vous des mauvais éléments qui vous entourent. Essayez, si vous y arrivez, de vous entourer d'éléments positifs. Si vous trouvez la force requise, devenez un élément positif dans la vie des gens qui n'arrivent pas à en devenir un. Aidez les personnes en détresse à surmonter ensemble les douleurs de leur quotidien.
EOT
);
___('politics_manifesto_philosophy_4',      'EN', <<<EOT
No system can be toppled with anger alone, as people fear anger instead of listening or helping. Change must come from within, and it begins within yourself. Society must be shown a positive image of alternative movements, one of people who have found strength in themselves and in each other. For those who have the means to become better versions of themselves, use it to lay the foundations required to change the system. In the workplace, unionize. On your free time, volunteer. Around others, spread political theory and deconstruct the system, reassure those who think there is no hope.
EOT
);
___('politics_manifesto_philosophy_4',      'FR', <<<EOT
Aucun système ne peut être renversé par la colère, car les gens craignent la colère au lieu d'écouter ou d'aider. Le changement doit venir de l'intérieur, en commençant par soi. Il faut donner à la société une image positive des mouvements alternatifs, une image de personnes qui trouvent de la force en soi-même et dans les autres. Si vous avez les moyens de devenir une version meilleure de vous-même, canalisez cette énergie vers la mise en place des fondations requises pour renverser le système. Sur votre lieu de travail, syndiquez-vous. Sur votre temps libre, faites du bénévolat. Autour des autres, diffusez de la théorie politique et apprenez à déconstruire les problématiques systémiques, rassurez les gens qui ont perdu espoir.
EOT
);
...
This manifesto was written by listening. Prior to writing the very first word, a lot of time had already been spent talking with people from many different backgrounds about their lack of political representation. As it turns out, listening is an underrated tool, you can learn a lot about yourself and others from developing the ability to truly listen instead of simply hearing.
EOT
);
___('politics_manifesto_listening_1',       'FR', <<<EOT
Ce manifeste est le produit de l'écoute. Avant même d'en avoir écrit le premier mot, beaucoup de temps avait déjà été consacré à échanger avec des personnes de nombreux milieux sociaux au sujet de leur manque de représentation politique. Il s'avère que l'écoute est un outil sous-estimé, vous apprenez beaucoup sur vous-même et sur le monde lorsque vous apprenez à réellement écouter au lieu de simplement entendre.
EOT
);
...
Bien entendu, tout le monde ne mérite pas d'être écouté. Les fascistes et autres membres de groupes oppressifs peuvent se parler entre eux, ce n'est pas de votre devoir de les écouter ou d'essayer de changer leurs opinions. Mais tant qu'une personne souffre de violences systémiques - même si son opinion politique est à l'opposé de la vôtre - il est crucial de la laisser vous expliquer de quelle façon elle vit ces violences. Même les gens qui semblent être intrinsèquement mauvais ne sont parfois que des âmes perdues, malavisées, une bonne nature se cachant sous la surface. Pas toujours, mais parfois.
EOT
);
...
Nous n'aurons très probablement qu'une seule chance de décider de l'avenir que nous voudrons une fois le système capitaliste renversé. Ce futur doit impérativement prendre en considération les besoins de tous les groupes défavorisés, pas seulement des groupes dont la voix est assez forte pour se faire entendre par-dessus les autres. N'oubliez pas que tout conflit, même s'il peut sembler en apparence être une forme de violence unilatérale, peut très bien cacher un conflit de classe, sous la surface duquel les classes défavorisées souffrent des deux côtés du conflit. C'est pourquoi il faut toujours prendre le temps d'écouter plutôt que de juger.
EOT
);
___('politics_manifesto_listening_5',       'EN', <<<EOT
In order to grow as a person and as a member of society, you should put this in practice. Assemble or join social circles, and keep them open to anyone who wants to talk. Be welcoming. Hold workshops where you simply listen to each other, get your issues off your chest. Build a sense of community and grow these circles into caring and respectful small scale social structures.
EOT
);
___('politics_manifesto_listening_5',       'FR', <<<EOT
Afin de grandir en tant que personne et que membre de la société, pratiquez l'écoute active. Créez ou rejoignez des cercles sociaux, et gardez-les ouverts aux personnes qui voudraient parler. Organisez des ateliers où vous prenez le temps de vous écouter entre vous, afin d'apprendre à vous libérer collectivement du poids de vos problèmes. Construisez des communautés en faisant grandir ces cercles jusqu'à ce qu'ils deviennent des structures sociales locales, ouvertes, attentives, et respectueuses.
EOT
);
...
C'est de cette façon que ce manifeste est né : en écoutant les voix qui se sont exprimées dans ces cercles, demandant une option supplémentaire au sein des mouvements politiques anti-capitalistes. La plainte qui revenait le plus était qu'au sein des mouvements communistes, anarchistes, féministes, les gens parlaient trop en leur nom, au lieu de les écouter. L'épuisement causé par des tentatives constantes d'écraser leur parole, à coup de mansplaining, cissplaining, straightsplaining, ablesplaining, kāfirsplaining, goysplaining, mène toujours à la même demande : écoutez-nous. Nous sommes là.
EOT
);
___('politics_manifesto_listening_7',       'EN', <<<EOT
Once you have listened enough, there is nothing wrong with carrying the voices of those you listened to and actually representing them when necessary. Just make sure that you are genuinely open at all times to their feedback, and that you never claim to be speaking in their name but only in yours. For example, a man defending women's rights should not claim to be speaking in the name of women, but rather make it clear that he is representing his understanding of women's issues from listening to them and caring for their cause.
EOT
);
___('politics_manifesto_listening_7',       'FR', <<<EOT
Une fois que vous avez fait l'effort de réellement écouter, il n'y a aucun problème à porter la voix des autres afin de les représenter lorsque cela vous semble nécessaire. Assurez-vous simplement de toujours avoir la disponibilité requise pour prendre en compte leurs remarques, et de ne jamais parler en leur nom mais uniquement en votre propre nom. Par exemple, un homme défendant les droits des femmes ne doit pas prétendre parler au nom des femmes, mais plutôt clarifier qu'il défend une vision basée sur l'écoute de la cause féministe, dont il se soucie réellement.
EOT
);
___('politics_manifesto_listening_8',       'EN', <<<EOT
...
___('politics_manifesto_solutions_intro',     'EN', <<<EOT
...
___('politics_manifesto_solutions_intro',     'FR', <<<EOT
Tout ce qui a été discuté plus tôt, le négatif comme le positif, peut se résumer en 40 propositions pour un avenir meilleur. Ce ne sont pas des règles à suivre, ces propositions ne sont ni strictes ni immuables, il s'agit plutôt de lignes directrices menant vers une société libre de la violence du capitalisme et de ses effets secondaires, sans pour autant le remplacer par un autre système injuste ou violent.
EOT
);
...
___('politics_manifesto_praxis_quote',      'EN', "The system must fall apart before the planet does");
___('politics_manifesto_praxis_quote',      'FR', "L'effondrement du système doit avoir lieu avant que notre planète s'effondre");
...
___('politics_manifesto_postface_quote',  'FR', "La société nous méprise. Nous devons, en retour, mépriser la société.");
...
Si ce manifeste fait écho à vos tendances politiques, la cause commune vous attend. Rejoignez un cercle social, devenez l'un des nôtres, pratiquez la praxis, et partagez le manifeste avec d'autres personnes.
EOT
);
...
N'oubliez pas que le contrapositionnisme - le fait de s'opposer à tout ce que le système représente - est avant tout basé sur l'écoute des autres. Par conséquent, le contenu de ce manifeste n'est pas figé, il évoluera au fur et à mesure des retours, des débats, des conversations, des ateliers. Qui plus est, la société change et évolue constamment : certaines parties du manifeste peuvent perdre leur pertinence, et nécessiter d'être mises à jour.
EOT
);
...
Le message, lui, ne changera jamais : la société nous méprise. Nous devons, à notre tour, mépriser la société.
EOT
);
