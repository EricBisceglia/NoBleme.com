    ...
    <fieldset>
      ...
      <div class="flexcontainer">
        <div class="flex spaced_right">
          ...
          <label for="compendium_category_add_body_en"><?=__('compendium_category_add_body_en')?></label>
        ...
        <div class="flex spaced_left">
          ...
          <label for="compendium_category_add_body_fr"><?=__('compendium_category_add_body_fr')?></label>
