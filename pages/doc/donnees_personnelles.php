...
- Ces données ne sont visibles que par vous même et par <a href="{$chemin}pages/users/user?id=1">l'administrateur du site</a><br>
...
- This data is only visible to yourself and <a href="{$chemin}pages/users/user?id=1">the website's administrator</a><br>
...
EOD;
  ...
  $trad['cs_desc']    = <<<EOD
When you <a class="gras" href="{$chemin}pages/users/login">log into your account</a>, there is an optional "Remember me" checkbox. If it is checked when you log in, then a cookie is automatically stored on your computer. This cookie allows NoBleme to remember that you want to stay logged into your account from one visit to another, even if you close your browser or your computer between visits.
EOD;

  // Données liées au compte
  $trad['dc_titre']   = "Personal data linked to your account";
  $trad['dc_guest']   = <<<EOD
As you are currently a guest (you are not <a class="gras" href="{$chemin}pages/users/login">logged into an account</a> on NoBleme), no additional personal data is stored.
EOD;
  $trad['dc_pseudo']  = "Your nickname:";
  $trad['dc_pdesc']   = <<<EOD
When you created your account, you chose this as your nickname. It is used to publicly identify you on the whole website, and everyone can see it publicly. If you have a good reason to want to change your nickname, you can make a request on the "<a class="gras" href="{$chemin}pages/users/pseudo">Change my nickname</a>" page
EOD;
  $trad['dc_email']   = "Your e-mail address:";
  $trad['dc_edesc']   = <<<EOD
Even though NoBleme offers to optionally link an e-mail address to your account, it is a private information that only you and the <a href="{$chemin}pages/users/user?id=1">website's administrator</a> can see, and it will never be used by the website: we will never send you mass e-mails or newsletters, and we will never share this information with a third party. The reason why we offer to store your e-mail address is for recovery purposes. In case you ever lose your account's password, you can recover it using an e-mail which gets sent to the e-mail address that you stored on the website. If you want to edit or remove your e-mail address, you can do so on the "<a class="gras" href="{$chemin}pages/users/email">Change my e-mail</a>" page.
EOD;
  $trad['dc_autres']  = "Other data linked to your account";
  $trad['dc_adesc']   = <<<EOD
As you use NoBleme, various informations appear on your <a class="gras" href="{$chemin}pages/users/user">public profile</a>. Some of those informations have been put there by yourself, and you can edit or delete them at any time on the "<a class="gras" href="{$chemin}pages/users/profil">Edit my profile</a>" page. The other informations are statistics linked to your usage of the website, and can not be deleted. If you have a good reason to want those gone, you can make a request that your account gets deleted through the "<a class="gras" href="{$chemin}pages/users/delete">Delete my account</a>" page, and everything that's listed on your profile will disappear along with your account.
EOD;
}
