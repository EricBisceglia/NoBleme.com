...
/************************************************************************************************/ include './../../inc/header.inc.php'; ?>
      ...
      <div class="texte">
        ...
        <p>
          Les contenus statiques des pages de NoBleme (ceux qui font partie du code source du site et ne sont pas rédigés par les utilisateurs du site) sont la responsabilité personnelle de l'auteur et administrateur du site, <a class="gras" href="<?=$chemin?>pages/user/user?id=1">Éric Bisceglia</a>. Ce contenu est protégé, via son <a class="gras" href="<?=$chemin?>pages/nobleme/coulisses">code source</a>, par la <a class="gras" href="https://fr.wikipedia.org/wiki/Licence_MIT">Licence MIT</a>. Cette licence est volontairement très permissive et vous autorise à réutiliser, modifier, ou même vendre tout le contenu que vous le désirez, à condition de créditer l'auteur initial et de conserver la notice de propriété intellectuelle contenue dans la licence : <span class="italique">« Copyright (c) 2005 Eric Bisceglia / NoBleme.com »</span>.
        </p>
