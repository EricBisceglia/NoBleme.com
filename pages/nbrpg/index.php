...
<p>
  After a final story arc in 2015 which concluded ten years of storylines, the classic version of the NoBlemeRPG reached the end of its life cycle. A modernized version of the NBRPG, playable through the browser, had been assembled in 2016. Sadly, <a class="gras" href="{$path}pages/user/user?id=1">Bad</a> being a perfectionist, he did not want to release a game that wasn't 100% fun. As the remake is only about 90% fun, it will be back once Bad finds the missing 10%. One of those days...
</p>
EOD;
