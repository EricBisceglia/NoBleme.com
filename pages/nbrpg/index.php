...
else if($lang == 'EN')
{
  ...
  $trad['desc']       = <<<EOD
<p>
  For a whole decade, NoBleme users got on <a class="gras" href="{$chemin}pages/irc/index">our IRC server</a> to play a rather special role playing game called the NoBlemeRPG. In this non linear game, a group of players which changed every session had to accomplish errands for a mysterious entity called the Oracle, evolving through a game universe in which literally every action imaginable was possible to attempt.
</p>
<p>
  After a final story arc in 2015 which concluded ten years of storylines, the classic version of the NoBlemeRPG reached the end of its life cycle. A modernized version of the NBRPG, playable through the browser, had been assembled in 2016. Sadly, <a class="gras" href="{$chemin}pages/user/user?id=1">Bad</a> being a perfectionist, he did not want to release a game that wasn't 100% fun. As the remake is only about 90% fun, it will be back once Bad finds the missing 10%. One of those days...
</p>
EOD;
...
/************************************************************************************************/ include './../../inc/header.inc.php'; ?>
      ...
      <div class="texte">
        ...
        <div class="align_center">
          <img src="<?=$chemin?>img/divers/nbrpg.png" alt="NoBlemeRPG"><br>
