...
/************************************************************************************************/ include './../../inc/header.inc.php'; ?>
    ...
    <div class="body_main midsize">
      ...
      <ul class="dotlist">
        ...
        <li>
          Un serveur utilisant <a class="dark blank gras" href="http://en.wikipedia.org/wiki/Debian">Debian Linux</a> hébergé chez <a class="dark blank gras" href="http://www.ovh.fr/">OVH</a>
        </li>
        <li>
          Un serveur IRC utilisant une version personnalisée du daemon <a class="dark blank gras" href="http://en.wikipedia.org/wiki/UnrealIRCd">UnrealIRCd</a> et les <a class="dark blank gras" href="http://fr.wikipedia.org/wiki/Services_IRC">services</a> Anope
        </li>
        <li>
          Un serveur HTTP <a class="dark blank gras" href="http://en.wikipedia.org/wiki/Apache_HTTP_Server">Apache</a>
        </li>
        <li>
          Un site codé majoritairement en <a class="dark blank gras" href="http://en.wikipedia.org/wiki/PHP">PHP</a> puis rendu en <a class="dark blank gras" href="http://en.wikipedia.org/wiki/HTML">HTML</a>
        </li>
        <li>
          Une base de données <a class="dark blank gras" href="http://en.wikipedia.org/wiki/MySQL">MySQL</a> avec laquelle le PHP intéragit via des requêtes
        </li>
        <li>
          Du <a class="dark blank gras" href="http://en.wikipedia.org/wiki/CSS">CSS</a> pour régir l'apparence du HTML rendu par le PHP
        </li>
        <li>
          Du <a class="dark blank gras" href="http://en.wikipedia.org/wiki/JavaScript">JavaScript</a> pour conférér des fonctionnalités dynamiques à certaines pages
        </li>
        <li>
          Le site est développé depuis mon ordinateur opérant sous <a class="dark blank gras" href="http://en.wikipedia.org/wiki/Windows">Microsoft Windows</a> et contenant des machines virtuelles <a class="dark blank gras" href="http://en.wikipedia.org/wiki/FreeBSD">FreeBSD</a>
        </li>
        <li>
        ...
        <li>
          Le code source du site est écrit avec l'éditeur <a class="dark blank gras" href="http://en.wikipedia.org/wiki/Emacs">Emacs</a> sous FreeBSD et <a class="dark blank gras" href="http://en.wikipedia.org/wiki/Sublime_Text">Sublime Text</a> sous Windows
        </li>
        <li>
          Les graphismes sont tous réalisés sous <a class="dark blank gras" href="http://en.wikipedia.org/wiki/MS_Paint">Microsoft Paint</a> (même pas honte)
        </li>
        <li>
        ...
        <li>
          Les modifications sont traquées et publiées à l'aide du logiciel de gestion de versions <a class="dark blank gras" href="http://en.wikipedia.org/wiki/Mercurial">Mercurial</a>
        </li>
      </ul>
    </div>
